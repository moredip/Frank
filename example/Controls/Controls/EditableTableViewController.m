...
{
    NSString *stringToMove = [[_names objectAtIndex:fromIndexPath.row] retain];
    [_names removeObjectAtIndex:fromIndexPath.row];
    [_names insertObject:stringToMove atIndex:toIndexPath.row];
